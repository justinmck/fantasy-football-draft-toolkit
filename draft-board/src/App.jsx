      ...
      <div className="flex min-h-screen items-center justify-center p-6">
        <div className="card w-full max-w-md p-7 text-center">
          ...
          <button
            ...
            className="mt-5 h-10 w-full rounded-lg bg-accent-fill text-sm font-semibold text-white
              transition hover:bg-accent-fill-hover"
          >
            Reload the board
          </button>
          <pre className="mt-4 max-h-32 overflow-auto rounded bg-surface-sunken p-3 text-left text-[11px]
            leading-relaxed text-ink-faint scroll-slim">
